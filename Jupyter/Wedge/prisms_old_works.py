...
"""
Recovered from commit <f190e21> 3 weeks ago
"""
...
class Prism():
    ...
    def geometry(self, target_total_biso=2012):
        ...
        # Z-planes
        s130 = openmc.ZPlane(surface_id=130, z0=  -2.5, boundary_type="vacuum")  # 
        ...
        s139 = openmc.ZPlane(surface_id=139, z0= 534.9, boundary_type="vacuum")  #   2.5 cm - outboard outer eurofer
