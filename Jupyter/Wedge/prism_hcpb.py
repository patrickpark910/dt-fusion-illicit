...
class Prism():
    ...
    def tallies(self, debug=False):
        ...
        Li_tally_tot    = self.make_tally('Li rxn rates total',    ['(n,Xt)', '(n,gamma)'], nuclides=['Li6', 'Li7'])
        ...
        Be_tally_tot    = self.make_tally('Be rxn rates total',    ['(n,2n)'], nuclides=['Be9'])
        ...
        depth_ngamma            = self.make_tally('Reactions per nuclide-depth',        ['(n,gamma)','nu-fission','(n,2n)','(n,Xt)'],           nuclides=['U238', 'U235', 'Th232', 'Li6', 'Li7', 'Be9'], filters=[depth_mesh_filter])
