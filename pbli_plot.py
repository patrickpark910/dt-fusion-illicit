...
class PlotStatepointPbLi:
    ...
    def plot_rxn_rates(self):
        ...
        for i, cell_id in enumerate(self.cell_ids):
            ...
            plt.title(f'Reaction rates, {self.u_list[i]} MTU (PbLi, {self.e}wt% Li-6, log-log)')
            ...
            plt.title(f'Reaction rates, {self.u_list[i]} MTU (PbLi, {self.e}wt% Li-6, lin-log)')
